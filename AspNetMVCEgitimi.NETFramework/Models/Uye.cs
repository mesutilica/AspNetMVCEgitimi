...
using System.Linq;
using System.Web;
using System.ComponentModel.DataAnnotations; // Model validation için
...
namespace AspNetMVCEgitimi.NETFramework.Models
{
    public class Uye
    {
        ...
        [Required(ErrorMessage = "Lütfen Adınızı Giriniz!"), StringLength(50)] // Rquired attribute ü property nin üzerine eklenir ve o property i zorunlu hale getirir
        ...
        [MaxLength(11, ErrorMessage = "Tc Kimlik Numarası En Fazla 11 Karakter Olmalıdır")] // bu alana girilebilecek maksimum karakter sayısı
